...
Route::namespace('Admin')->group(function(){
    Route::put('/dashboard/login', [AuthAdminController::class,'login'])->name('admin.login');
    Route::get('/dashboard/do-login', [AuthAdminController::class,'doLogin'])->name('admin.doLogin');
