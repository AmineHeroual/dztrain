            ...
            <div class="col-sm-6 col-md-4 col-xl-4">
                <div class="single-footer-widget footer_2">
                    ...
                    <div class="social_icon">
                        ...
                        <a href="{{$settings->youtube}}"> <i class="ti-youtube"></i> </a>
                    </div>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://amineheroual.github.io" target="_blank">Amine Heroual</a>
